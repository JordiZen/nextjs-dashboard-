...
export default function ConstruccioPage() {
  ...
  cols={{ lg: 6, md: 4, sm: 2 }}
  rowHeight={240}
  margin={[20, 20]}   // marge horitzontal 20px, vertical 40px
  isResizable={false}
  isDraggable={false}
>
      
        <div key="1"><Widget size="1x1" title="Calculador Iva"><CalculadoraMetresQuadrats /></Widget></div>
        ...
        <div key="6"><Widget size="2x2" title="Totxanes">...</Widget></div>
        <div key="7"><Widget size="1x2" title="Totxanes">...</Widget></div>
        <div key="8"><Widget size="1x1" title="Grava2">...</Widget></div>
        <div key="9"><Widget size="1x1" title="Grava2">...</Widget></div>
